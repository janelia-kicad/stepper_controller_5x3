...
~ENABLE
$Comp
L stepper_controller_5x3:MAX6817 U5
U 1 1 58DB7355
P 6050 6150
...
F 2 "stepper_controller_5x3:MAX6817" H 6200 5800 60  0001 C CNN
...
F 2 "stepper_controller_5x3:SM0805" H 4088 1150 30  0001 C CNN
...
Wire Wire Line
	5350 3300 5400 3300
$Comp
L stepper_controller_5x3:OPTOISO_2CHAN U6
U 1 1 5C9B5633
P 2950 6200
...
REFR_BI
$Comp
L stepper_controller_5x3:0.1uF C8
U 1 1 5C9BBB71
P 2000 6200
...
F 2 "stepper_controller_5x3:SM0805" H 2038 6050 30  0001 C CNN
...
REFR_PWR
$Comp
L stepper_controller_5x3:845 R4
U 1 1 5C9EC1F2
P 2900 7200
...
REF_GND
$Comp
L stepper_controller_5x3:845 R3
U 1 1 5C9EFBCC
P 2400 7200
...
$EndComp
$Comp
L stepper_controller_5x3:845 R6
U 1 1 5C9F0F71
P 3900 7200
...
REFR_GND
$Comp
L stepper_controller_5x3:845 R5
U 1 1 5C9F0F8B
P 3400 7200
...
$EndComp
$Comp
L stepper_controller_5x3:BUFFER_TRI_STATE U4
U 1 1 5CA155A2
P 2700 2550
...
F 2 "stepper_controller_5x3:SM0805" V 1530 2600 30  0001 C CNN
...
$EndComp
$Comp
L stepper_controller_5x3:0.1uF C11
U 1 1 58DB75FF
P 5000 6200
...
F 2 "stepper_controller_5x3:SM0805" H 5038 6050 30  0001 C CNN
...
$EndComp
$Comp
L stepper_controller_5x3:0.1uF C9
U 1 1 5CB1203F
P 3800 6200
...
F 2 "stepper_controller_5x3:SM0805" H 3838 6050 30  0001 C CNN
...
$EndComp
$Comp
L stepper_controller_5x3:0.1uF C10
U 1 1 5CB171EC
P 4250 6200
...
F 2 "stepper_controller_5x3:SM0805" H 4288 6050 30  0001 C CNN
